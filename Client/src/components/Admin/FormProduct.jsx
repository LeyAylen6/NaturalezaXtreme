        ...
        <form onSubmit={handleSubmit}>
          <Box mb={10}>
            <FormControl isInvalid={errors.name}>
              ...
              <Input type="text" name="name" value={form.name} placeholder="Article name" border={"1px"} onChange={handleChange} />
              {!errors.name ? (
          ...
          <Box mb={10}>
            <FormControl isInvalid={errors.type}>
              ...
              <Select name="type" value={form.type} onChange={handleChange} border={"1px"}>
          ...
          <Box mb={10}>
            <FormControl isInvalid={errors.gender}>
              ...
              <Select name="gender" value={form.gender} onChange={handleChange} border={"1px"}>
                <option value="none">None</option>
          ...
          <Box mb={10}>
            <FormControl isInvalid={errors.color}>
              ...
              <Select name="color" value={form.color} onChange={handleChange} border={"1px"}>
                <option value="none">none</option>
          ...
          <Box mb={10}>
            <FormControl isInvalid={errors.price}>
              ...
              <NumberInput name="price" value={form.price} onChange={(value) => handleChange({ target: { name: "price", value } })}>
                <NumberInputField />
              </NumberInput>
              {!errors.price ? (
